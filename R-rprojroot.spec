...
Version  : 2.1.0
Release  : 68
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/rprojroot_2.1.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/rprojroot_2.1.0.tar.gz
...
%setup -q -n rprojroot
pushd ..
cp -a rprojroot buildavx2
popd
pushd ..
cp -a rprojroot buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752502682
...
/usr/lib64/R/library/rprojroot/tests/testthat/setup.R
...
/usr/lib64/R/library/rprojroot/tests/testthat/test-utils.R
